document.addEventListener('DOMContentLoaded', () => {
    ...
    // DESACTIVADO: Los hotspots ahora se manejan con React - usar array vacío
    const hotspots = []; // Array vacío para evitar que el script.js intente animarlos
    ...
    const animateHotspots = () => {
        // DESACTIVADO COMPLETAMENTE - Ahora se usa el hook de React useHotspotPhysics
        // Esta función ya no debe ejecutarse para evitar conflictos
        return;
    ...
    const handleHotspotMediaChange = () => {
        // DESACTIVADO: initHotspotMotion() - Ahora se usa el hook de React useHotspotPhysics
        // initHotspotMotion();
    };
...
const homeSlideLabels = {
    ...
    window.addEventListener('resize', () => {
        // DESACTIVADO: updateHotspotBounds y rebuildHotspotNodes - Ahora se usa el hook de React
        // updateHotspotBounds();
